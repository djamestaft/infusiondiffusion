...
The approved responsive storefront compositions are integrated across Home, Collection, Product detail, Fragrance Guide, About, Contact, Gallery, and cart on the active redesign delivery branch. Gallery remains intentionally unchanged, while the other customer-facing surfaces now use the approved expanded hierarchy and responsive composition without crossing Sanity editorial or Shopify commerce ownership boundaries.

...
13. Pi is the project team orchestrator. Follow `.agents/skills/orchestrate-pi-team/SKILL.md`; keep worker communication coordinator-mediated, give MCP only to named roles, and allocate a separate Treehouse worktree before every writing delegation.

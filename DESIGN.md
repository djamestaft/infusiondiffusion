...
The Figma foundations are approved. Repository CSS migration is incremental: AnnouncementBar, Button, TextLink, Input, Textarea, Field, ProductCard, Navigation, PriceDisplay, and CommerceStatus are synchronized with their approved Figma sources; remaining provisional holding-page styles are not approved brand truth.

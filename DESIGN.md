...
`HeroCarousel` is approved in the [desktop homepage](https://www.figma.com/design/GYiQd7QSAwCSaGtt0alKG2/Infusion-Diffusion-Designs-WEB?node-id=296-100), [mobile homepage](https://www.figma.com/design/GYiQd7QSAwCSaGtt0alKG2/Infusion-Diffusion-Designs-WEB?node-id=296-174), [desktop first-slide](https://www.figma.com/design/GYiQd7QSAwCSaGtt0alKG2/Infusion-Diffusion-Designs-WEB?node-id=296-239), [desktop progress](https://www.figma.com/design/GYiQd7QSAwCSaGtt0alKG2/Infusion-Diffusion-Designs-WEB?node-id=296-262), [mobile first-slide](https://www.figma.com/design/GYiQd7QSAwCSaGtt0alKG2/Infusion-Diffusion-Designs-WEB?node-id=296-286), and [mobile progress](https://www.figma.com/design/GYiQd7QSAwCSaGtt0alKG2/Infusion-Diffusion-Designs-WEB?node-id=296-309) frames. It isolates one to three 4:5 editorial images from the stable homepage H1, copy, and CTA. Antique Gold cabinet-register lines remain inside the media at 10% opacity; they never merge with or diminish Navigation's full-width, full-strength semantic gold bottom divider. Visible caption/position text is omitted so it cannot compete with the register pattern; assistive technology retains slide identity and count. Pagination and pause/play controls retain 44px targets. Autoplay advances once after eight seconds and is suppressed for reduced motion, Save-Data, document hiding, hover, focus, or interaction. `Components/HeroCarousel` in Storybook records its responsive, interaction, content-extreme, loading, empty, and failure contracts.

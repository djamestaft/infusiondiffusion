...
Evolve the existing brand into a cohesive premium shopping journey: Home, Shop, product detail, the existing cart and Shopify-hosted checkout handoff, plus essential brand and service pages. Shopify commerce and Sanity CMS integrations already exist and must be preserved. INF-32 is shaping the revised journey using existing imagery and verified content. Final photography, outstanding product/service facts and Sanity SEO are deferred by Devon's 8 September decision; the new Fragrance Guide is also deferred. Approve revised Figma compositions before implementation, then verify the integrated journey. Gallery refinement follows the shopping milestone. See `docs/planning/roadmap.md` for current approval status, Plane tickets and delivery order.

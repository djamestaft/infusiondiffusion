...
Run from the **target repo root** — the cwd is where everything lands. If the skill lives in your user scope, use the corresponding user-scoped Codex skills path.

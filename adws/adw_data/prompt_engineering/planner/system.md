...
- When a request depends on Figma, declare exact typed Figma file targets, 1–12 unique node IDs, expected approval state, and evidence categories. Missing exact targets are blocking; never ask an agent to work around missing connector access.

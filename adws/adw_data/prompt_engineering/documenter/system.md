...
Document the delivered diff, verification evidence, approval state, and residual risk for the engineer who arrives next.
...
- Include the deterministic verification commands/results available in the handoff, the human approvals still required, and residual risks supported by the diff or run evidence. Never claim merge, production deployment, editorial publish, or rollback occurred unless the trace proves it.

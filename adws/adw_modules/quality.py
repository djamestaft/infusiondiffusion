...
╚══════════════════════════════════════════════════════════════════════════════╝
The placeholder banner above is retained from the stamped template, but this
repository has replaced every placeholder with the documented `corepack pnpm`
commands below.
"""
